 ...
 */
static void zread_srv6_manager_get_locator_static_sids(struct zserv *client,
							 struct stream *msg,
							 vrf_id_t vrf_id)
{
	struct stream *s = msg;
	...
	srv6_manager_get_locator_static_sids_call(&locator, static_sids_list, client, locator_name, vrf_id);
...
static void zread_srv6_manager_request(ZAPI_HANDLER_ARGS)
{
	...
	case ZEBRA_SRV6_MANAGER_GET_LOCATOR_STATIC_SIDS:
		zread_srv6_manager_get_locator_static_sids(client, msg,
							 zvrf_id(zvrf));
